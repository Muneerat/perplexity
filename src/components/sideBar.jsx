...
export const SideBar = () => {
  return (
    <nav className="px-6 py-3 min-w-[16%] w-[17%] h-screen static flex justify-between flex-col">
      <div>
      ...
      <div>
       ...
       <div className="text-secondary">Upgrade for image upload, smarter AI, and more Pro Search.</div>
       <Link className="flex items-center gap-2 bg-[#e8e8e3] text-general w-fit p-2 rounded-md"><ArrowUp width={15} height={15} /> Learn More</Link>
       <div className=""></div>
      </div>
